...
\begin{cventries}
	...
	{2026 --- Present} % Date(s)
	{
		\begin{cvitems} % Description(s) of tasks/responsibilities
			...
			\item{Demonstrated that spin chirality is spontaneously generated in time-reversal symmetry broken systems without any spin-orbit coupling}
	...
	\cventry
	{With Prof. Leonid Levitov and Vladislav Poliakov} % Prof
	%{Aspects of spin chirality and tunneling density of states in superconductors with broken time-reversal symmetry} % Subject
...
\cventry
{With Prof. Leonid Levitov, Prof. Nandini Trivedi, and Penghao Zhu} % Prof
%{Aspects of spin chirality and tunneling density of states in superconductors with broken time-reversal symmetry} % Subject
{Deducing symmetry properties and topological phase winding of unconventional superconductors with STM} % Subject
{MIT, Cambridge, MA, USA} % Location
{2024 --- Present} % Date(s)
