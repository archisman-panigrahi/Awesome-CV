...
%---------------------------------------------------------
  \cventry
	...
	\cventry
	{Manuscripts in preparation} % Role
	{} % Title
	{} % Location
	{} % Date(s)
	{
	\begin{cvitems} % Description(s)
		\item{\textbf{A. Panigrahi}, V. Juri\v{c}i\'c, B. Roy; \textit{Emergence of topological properties of parent crystals in projected topological phases.}}
	\end{cvitems}
	}
%---------------------------------------------------------
\end{cventries}
